...
public class AuthController {
	private final com.bezkoder.spring.security.postgresql.security.services.service_logic service_logic;
	@Autowired
	...
	public ResponseEntity<String> verif_email(@PathVariable String email)
	{
		log.info(email);


		return ResponseEntity.ok().body(service_logic.code_verification(email));
	}
